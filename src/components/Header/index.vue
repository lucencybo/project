  ...
  methods: {
    ...
    toSearch() {
      let location = {
       ...
       要么不指定params参数 要么传递过去一个undefined代表什么都没有传，不能直接传空串
        前提 params参数可传不可传
       */
        ...
        name: "search",
        params: {
          keyword: this.keyword || undefined, //如果传递params参数是一个空串，那么路径就会有问题，传过去如果是undefined就没事
        },
        // query: {
      ...
      // this.$router.push(location) //对象   用来处理多次push点击报错的问题
    },
    async logout() {
      try {
